...
function initHero() {
  ...
  const B = { eyebrow: 'Original Members', title: '[Black]', href: '/original-members-polo?color=black' };
  const W = { eyebrow: 'Original Members', title: '[White]', href: '/original-members-polo?color=white' };
